...
#define JK_NUM_WHEEL_BUTTONS (2)
#else
#define JK_NUM_WHEEL_BUTTONS (0)
#endif
...
#define JK_NUM_EXTENDED_KEYS \
    ((JK_JOYSTICK_BUTTON_STRIDE * JK_NUM_JOYSTICKS) + \
     JK_NUM_MOUSE_BUTTONS + JK_NUM_EXT_MOUSE_BUTTONS + \
     (JK_JOYSTICK_EXT_BUTTON_STRIDE * JK_NUM_JOYSTICKS) + \
     JK_NUM_WHEEL_BUTTONS)
...
#define KEY_IS_MOUSE(x) \
    (((x) >= KEY_MOUSE_B1 && (x) <= KEY_MOUSE_B4) || \
     ((x) >= KEY_MOUSE_B5 && (x) < JK_EXT_MOUSE_END) || \
     ((x) >= KEY_MOUSE_WHEELUP && (x) <= KEY_MOUSE_WHEELDOWN))
...
#define KEY_MOUSE_WHEELUP       (KEY_JOY2_EXT_ENDIDX + 0)
#define KEY_MOUSE_WHEELDOWN     (KEY_JOY2_EXT_ENDIDX + 1)
